...
public class AnotherFurnitureFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlocks(RenderType.cutout(),
                ...
                AFBlocks.OAK_PICKET_FENCE.get(), AFBlocks.SPRUCE_PICKET_FENCE.get(), AFBlocks.BIRCH_PICKET_FENCE.get(), AFBlocks.JUNGLE_PICKET_FENCE.get(), AFBlocks.ACACIA_PICKET_FENCE.get(), AFBlocks.DARK_OAK_PICKET_FENCE.get(), AFBlocks.MANGROVE_PICKET_FENCE.get(), AFBlocks.CRIMSON_PICKET_FENCE.get(), AFBlocks.WARPED_PICKET_FENCE.get(),
