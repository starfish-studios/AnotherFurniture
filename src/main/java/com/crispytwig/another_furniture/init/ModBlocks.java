...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BIOMESOPLENTY_HELLBARK_CHAIR = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "hellbark_chair", () -> new ChairBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> BIOMESOPLENTY_HELLBARK_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "hellbark_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> BIOMESOPLENTY_HELLBARK_TABLE = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "hellbark_table", () -> new TableBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> SERVICE_BELL = RegistryUtil.createBlockAndItem("service_bell", () -> new ServiceBellBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
