...
public class ModBlocks {
    ...
    // Shelf
    public static final RegistryObject<Block> BIOMESOPLENTY_CHERRY_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "cherry_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_DEAD_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "dead_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_FIR_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "fir_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_HELLBARK_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "hellbark_shelf", () -> new ShelfBlock(Block.Properties.of(Material.NETHER_WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_JACARANDA_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "jacaranda_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_MAGIC_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "magic_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_MAHOGANY_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "mahogany_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_PALM_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "palm_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_REDWOOD_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "redwood_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_UMBRAN_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "umbran_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMESOPLENTY_WILLOW_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMESOPLENTY_ID, "willow_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMEMAKEOVER_ANCIENT_OAK_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMEMAKEOVER_ID, "ancient_oak_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMEMAKEOVER_BLIGHTED_BALSA_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMEMAKEOVER_ID, "blighted_balsa_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMEMAKEOVER_WILLOW_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMEMAKEOVER_ID, "willow_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> BIOMEMAKEOVER_SWAMP_CYPRESS_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.BIOMEMAKEOVER_ID, "swamp_cypress_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> ECOLOGICS_AZALEA_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.ECOLOGICS_ID, "azalea_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> ECOLOGICS_COCONUT_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.ECOLOGICS_ID, "coconut_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> ECOLOGICS_WALNUT_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.ECOLOGICS_ID, "walnut_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> ENHANCED_MUSHROOMS_BROWN_MUSHROOM_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.ENHANCED_MUSHROOMS_ID, "brown_mushroom_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> ENHANCED_MUSHROOMS_RED_MUSHROOM_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.ENHANCED_MUSHROOMS_ID, "red_mushroom_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    ...
    public static final RegistryObject<Block> QUARK_AZALEA_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.QUARK_ID, "azalea_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
    public static final RegistryObject<Block> QUARK_BLOSSOM_SHELF = RegistryUtil.createBlockAndItemCompat(CompatUtil.QUARK_ID, "blossom_shelf", () -> new ShelfBlock(Block.Properties.of(Material.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()));
